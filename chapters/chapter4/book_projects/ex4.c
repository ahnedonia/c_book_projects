...
int main(){
    ...
    int number, digit_one, digit_two, digit_three, digit_four, digit_five;
    ...
    printf("In octal, your number is: %1d%1d%1d%1d%1d", digit_one, digit_two,digit_three,digit_four,digit_five );
